...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'AI面试助手是大鱼AI超级智能体应用平台的专业面试助手，帮你解答各种面试问题，提供面试问题回答'
    },
    {
      name: 'keywords',
...
onMounted(() => {
  ...
  // 添加欢迎消息
  addMessage('我是你的AI面试官，请你按下面的模板补充信息，我会结合你的情况和需求帮你模拟面试和辅导。\n' +
      '比如：我是一名5年经验的Java后端开发工程师，目前比较欠缺分布式微服务、以及三高一海等相关经验，请你结合市场上的需求，帮我做模拟面试和辅导，给我相关的面试题和答案。', false)
})
